...
interface BatteryHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: BatteryHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_plugin_wyn.BatteryHostApi.getBatteryLevel$separatedMessageChannelSuffix", codec)
        if (api != null) {
